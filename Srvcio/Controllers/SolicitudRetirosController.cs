...
namespace Srvcio.Controllers
{
    public class SolicitudRetirosController : Controller
    {
        ...
        public async Task<ActionResult<IEnumerable<MdloDtos.SolicitudRetiroAutorizacion>>> ConsultarSolicitudRetiroAutorizacionHistorialIdRetiro(int IdSolicitudRetiroAutorizacion)
        {
            var ObDeposito = new List<MdloDtos.SolicitudRetiroAutorizacion>();
            //Tipo de Operacion
            int operacion = Convert.ToInt32(MdloDtos.Utilidades.Constantes.TipoOperacion.Consulta);
