...
public partial class SpListaDocumentosAprobacionCargue
{
    [Key]
    ...
    public decimal? Vmdo_trm { get; set; }

    public decimal? Vmdo_csto_sgro_flte { get; set; }

    public decimal? Vmdo_arncel_imprtcion { get; set; }
